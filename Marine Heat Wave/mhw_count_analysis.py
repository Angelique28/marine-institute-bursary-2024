...
mhw_count_file = r"C:\Users\acheryl\Desktop\mhw_series\mhw_count_analysis\mhw-counts-NW-W-SW.csv" # Download mhw-counts-NW-W-.csv

data = pd.read_csv(mhw_count_file)
...
# 
# # Plot mean line
# plt.plot(x, mean_y, color='red', linestyle='--', linewidth=3, label='Mean', zorder=10)
# 
# plt.xlabel('Year', fontsize=14)
# plt.ylabel('Marine Heat Wave Frequency', fontsize=14)
# plt.title('Annual Marine Heat Wave Frequency Across All Sites')
# plt.legend()
# plt.tight_layout()
# plt.show()
# =============================================================================
...
df_s = pd.read_csv(r"C:\Users\acheryl\Desktop\mhw_series\mhw_count_analysis\site_slopes.csv")
...
colors = ['darkblue', 'darkblue', 'darkgreen', 'darkgreen', 'darkgreen', 'darkgrey', 'darkgrey', 'darkgrey', 'darkgrey']
...
df_s['Region'] = ['Northwest', 'Northwest', 'West', 'West', 'West', 'Southwest', 'Southwest', 'Southwest', 'Southwest']
